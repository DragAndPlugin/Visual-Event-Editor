module.exports = function(Drag, RPGMAKER_NAME) {
	return {
		...
		selectVariableText: {
			type: "interactive", name: "Value", behavior: [0, 1],
			controller: Drag.VisualEvent.inputs.selectDirectVariable, 
			dependances: [Drag.VisualEvent.inputs.text, Drag.VisualEvent.inputs.variable],
		},
		selectTextPattern: {
			type: "interactive", name: "Pattern", behavior: [0, [1, 2]],
			controller: Drag.VisualEvent.inputs.selectTextRegex, 
			dependances: [Drag.VisualEvent.inputs.text, Drag.VisualEvent.inputs.regex, Drag.VisualEvent.inputs.regexFlag],
