module.exports = function(RPGMAKER_NAME) {
	return {
		...
		firstIndexVariable: {type: "variable", default: 1, name: "First Index"},
		lastIndexVariable: {type: "variable", default: 1, name: "Last Index"},
		...
		increment: {type: "integer", default: 1, name: "Increment"},
		...
		selectForLoopCondition: {type: "select", options: ["<", "<=", ">=", ">"], name: "Condition", data: "data-dataType='number'", default: 0},
		selectTextCasing: {type: "select", options: ["Upper Case", "Lower Case"], name: "Casing", data: "data-dataType='number'", default: 0},
		selectTextRegex: {type: "select", options: ["Text", "Regex"], name: "Pattern", data: "data-dataType='number'", default: 0},
		...
		regex: {type: "string", name: "Regex", default: 'a|b'},
		regexFlag: {type: "string", name: "Flag", default: 'gm'},
		replacement: {type: "text", name: "Replacement", default: ''},
	}
};