module.exports = function(RPGMAKER_NAME, VisualEvent, window) {
	return {
		...
		selectEasingType: {type: "select", options: ["Constant speed", "Slow start", "Slow end", "Slow start and end"], name: "Easing", data: "data-dataType='number'", default: 0},
		...
		selectCommonEventTrigger: {type: "select", options: ["None", "Autorun", "Parallel"], name: "Trigger", data: "data-dataType='number'", default: 0},
		...
		choicesOutput: {type: "stringArray", count: 6, name: "When", default: ["Yes", "No"], isOutput: true, textCommandContext: "choice"},
		...
		nameWithTextCommands: {type: "string", name: "Name", default: "", textCommandContext: "name"},
		notetagName: {type: "string", name: "Notetag", default: ""},
		formula: {type: "string", name: "Formula", default: "0"},
		text: {type: "text", name: "Text", default: ""},
		textWithTextCommands: {type: "text", name: "Text", default: "", textCommandContext: "message"},
		textWithScrollingTextCommands: {type: "text", name: "Text", default: "", textCommandContext: "scrollingText"},
