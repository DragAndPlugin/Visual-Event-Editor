...
// (function() {
	...
	Drag.VisualEvent.expandedEventCommandsUrl = "https://drag-and-plug-in.itch.io/visualevent-expandedeventcommands";
	...
	Drag.VisualEvent.openPluginManager = function() {
		Drag.VisualEvent.openWindow(
			...
			window.screen.width * 0.7, window.screen.height * 0.7, 0, 0, 
			{}
		);
	};
